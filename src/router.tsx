...
const Collections = Loader(lazy(() => import('src/content/applications/Collections')));
const Nfts = Loader(lazy(() => import('src/content/applications/NFTS')));
const CreateCollection = Loader(lazy(() => import('src/content/applications/Collections/CreateCollection')));
const CreateNFT = Loader(lazy(() => import('src/content/applications/NFTS/CreateNFT')));
