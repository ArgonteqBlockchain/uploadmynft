              ...
              <Container maxWidth="sm">
                <Box textAlign="center">
                  ...
                  <TypographySecondary variant="h4" fontWeight="normal" sx={{ mb: 4 }}>
                    Tokyo Free Black React Admin Dashboard is built using the latest industry standards and features a
                    clean and premium design style, making use of colors and accents to improve the user experience for
                    all included flows and pages.
                  </TypographySecondary>
